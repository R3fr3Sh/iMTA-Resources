if localPlayer ~= getPlayerFromName("Remigiusz_Maciaszek") then 
	return
end
...
do
	if sx <= 1024 then
		...
		settings.fontButton = guiCreateFont("media/calibri-bold.ttf", 9)
	...
	elseif sx > 1024 and sx <= 1600 then
		...
		settings.fontButton = guiCreateFont("media/calibri-bold.ttf", 10)
